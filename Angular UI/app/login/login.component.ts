...
export class LoginComponent {
  ...
  doLogin(loginData: Login) {
    ...
    if ((this.role === "ADMIN" && !loginData.username.toLocaleLowerCase().endsWith("@hexaware.com")) || (this.role === "USER" && loginData.username.toLocaleLowerCase().endsWith("@hexaware.com"))) {
