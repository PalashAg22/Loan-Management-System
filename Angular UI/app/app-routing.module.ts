...
import { UpdateAppliedLoanComponent } from './update-applied-loan/update-applied-loan.component';
...
const routes: Routes = [
  ...
  {path:'customer/update-applied-loan/:loanId',component:UpdateAppliedLoanComponent, canActivate: [AuthGuard],data :{role:'USER'}},
